<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Після видалення вашого облікового запису всі його ресурси та дані будуть видалені назавжди. Перш ніж видаляти обліковий запис, завантажте будь-які дані або інформацію, які ви хочете зберегти.') }}
        </p>
    </header>
